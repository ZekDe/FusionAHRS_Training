...
#define WIA  	 0x00 // should return 0x48
#define INFO   0x01
#define ST1    0x02  // data ready status bit 0
#define HXL    0x03  // data
#define HXH    0x04
#define HYL    0x05
#define HYH    0x06
#define HZL    0x07
...
void MPU9250_init(I2C_HandleTypeDef *hi2c,accScale_t accScale, gyroScale_t gyroScale);
void MPU9250_reset(I2C_HandleTypeDef *hi2c);
void MPU9250_calibrate(I2C_HandleTypeDef *hi2c, float *gyro, float *acc);
void MPU9250_selfTest(I2C_HandleTypeDef *hi2c, float *destination);
#endif
